...
export type GetNotesAggregateType<T extends NotesAggregateArgs> = {
    [P in keyof T & keyof AggregateNotes]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateNotes[P]> : Prisma.GetScalarType<T[P], AggregateNotes[P]>;
};
...
type GetNotesGroupByPayload<T extends NotesGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<NotesGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof NotesGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], NotesGroupByOutputType[P]> : Prisma.GetScalarType<T[P], NotesGroupByOutputType[P]>;
}>>;
export type NotesWhereInput = {
    ...
    subject?: Prisma.StringFilter<"Notes"> | string;
    title?: Prisma.StringFilter<"Notes"> | string;
    subTitle?: Prisma.StringNullableFilter<"Notes"> | string | null;
...
export type NotesScalarWhereWithAggregatesInput = {
    ...
    subject?: Prisma.StringWithAggregatesFilter<"Notes"> | string;
    title?: Prisma.StringWithAggregatesFilter<"Notes"> | string;
    subTitle?: Prisma.StringNullableWithAggregatesFilter<"Notes"> | string | null;
...
export type NotesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "subject" | "title" | "subTitle" | "content" | "createdAt" | "userId", ExtArgs["result"]["notes"]>;
...
export type NotesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<NotesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NotesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Notes'];
        meta: {
            name: 'Notes';
        };
    };
     ...
     * })
    **/
    count<T extends NotesCountArgs>(args?: Prisma.Subset<T, NotesCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], NotesCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends NotesGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, NotesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNotesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface Prisma__NotesClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    user<T extends Prisma.Notes$userArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Notes$userArgs<ExtArgs>>): Prisma.Prisma__UserClient<runtime.Types.Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>;
    /**
...
export interface NotesFieldRefs {
    ...
    readonly subject: Prisma.FieldRef<"Notes", 'String'>;
    readonly title: Prisma.FieldRef<"Notes", 'String'>;
    readonly subTitle: Prisma.FieldRef<"Notes", 'String'>;
